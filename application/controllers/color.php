...
.atributos,.light_blue,.curso_btn,.circle,.brand_line,.download_btn,.send_question,.current,.discusion_btn,.module_actual,.modulo_actual,.volver, .cert_btn{
...
/* ==========================================================================
    Color # 1 TEXTO
   ======================== ================================================== */
.curso_des h2, .encabezado_wrap h6,.encabezado2_wrap h6,.col2_wrap h4,.pensum_block h2,.teacher_col2 h3,.perfil_col2 h3,.disc_block_A_col2 span,.nosotros_col1 h2,.landing_col1 h3,.inbox_curso, .inbox_actividad,.box h3,.evaluacion_wrap h2,.landing h3,div#gracias{
  color:#0f8dcd;
}
/* ==========================================================================
    Color # 2
...
/* ==========================================================================
    Color # 2 TEXTO
   ======================== ================================================== */
.dark_blue,nav ul li,.atributo_wrap h2,h4,.plan_wrap h3,.question_wrap h5,.question_wrap h6,.discusion_respuesta_wrap h6,.login_wrap h3,.login_wrap h6{  
  color: #0c4a6e;
}
/* ==========================================================================
    Color # 3
...
/* ==========================================================================
    Color # 3 TEXTO
   ======================== ================================================== */
.desktop_nav a:link,.desktop_nav a:visited,.desktop_nav a:active,.atributo_wrap p, h5,.curso_des p,.testimonial_wrap p,.pepName h5,.pepName p,.col2_wrap p,.sus_col1 h3,.sus_col1 h4,.fecha,.sus_col2 h3,.explicacion_wrap,
...
.login_btn,.editar_btn,.evaluacion_btn,.tut_btn,.cta_btn_after,.thanks_btn{
  background-color:#5fcf80;
  color:#fff;
}

.login_btn:hover,.editar_btn:hover,.evaluacion_btn:hover,.tut_btn:hover,.cta_btn_after:hover,.thanks_btn:hover{
