...
#foreach ($this->input->post('plan_valor') as $key => $value) {
#$this->form_validation->set_rules('testi_nombres_completos', 'Nombres completos', 'required|xss_clean');
#}


/*
krumo ($this->input->post('plan_valor'));
krumo ($this->input->post('linea1'));
krumo ($this->input->post('linea2'));
krumo ($this->input->post('linea3'));
krumo ($this->input->post('linea4'));
krumo ($this->input->post('id_plan'));
*/
