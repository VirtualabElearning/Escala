              ...
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <?php echo input_text ("Nombre","nombre","nombre","Ingrese el nombre del estatus",$detalle->nombre); ?>
                    <?php echo form_error('nombre', '<div class="mensaje_error">', '</div>'); ?>

                    <?php echo textarea ("Descripcion","descripcion","descripcion","Ingrese la decripcion del estatus",$detalle->descripcion); ?>
