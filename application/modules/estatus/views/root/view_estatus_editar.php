              ...
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <?php echo textarea ("Descripcion","descripcion","descripcion","Ingrese la decripcion del estatus",$detalle->descripcion,form_error('descripcion', '<div class="mensaje_error">', '</div>')); ?>
                    <?php 
