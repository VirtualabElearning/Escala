              ...
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <?php echo input_text ("Titulo","titulo","titulo","Ingrese el titulo de la noticia",$detalle->titulo); ?>
                    <?php echo form_error('titulo', '<div class="mensaje_error">', '</div>'); ?>

                    <?php echo textarea ("Descripcion","descripcion","descripcion","Ingrese la decripcion de la noticia",$detalle->descripcion); ?>
                      ...
                      <div class="col-lg-5">
                        ...
                        <div class="fileupload <?php if ($detalle->foto): ?> fileupload-exists <?php else : ?> fileupload-new <?php endif ?>" data-provides="fileupload">
                          ...
                          <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;">            
                            <img src="<?php echo base_url().'uploads/cursos/'.$detalle->foto; ?>" alt="img"/>
                          </div>
                          <?php #endif ?>
                    ...
                    <?php echo editor ("Contenido","contenido","contenido",$detalle->contenido) ?>
