              ...
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <?php echo input_text ("Nombre","nombre_modulo","nombre_modulo","Ingrese el titulo del modulo",$detalle->nombre_modulo); ?>
                    <?php echo form_error('nombre_modulo', '<div class="mensaje_error">', '</div>'); ?>
                    <?php echo textarea ("Introduccion","introduccion_modulo","introduccion_modulo","Ingrese la introduccion del modulo",$detalle->introduccion_modulo); ?>
                    <?php echo form_error('introduccion_modulo', '<div class="mensaje_error">', '</div>'); ?>
                    <?php echo editor ("Contenido","contenido_modulo","contenido_modulo",$detalle->contenido_modulo) ?>
