							...
							<div class="widget">
								...
								<div class="widget-content">
									<div class="padd">
										...
										<?php echo input_text ("Nombre","nombre","nombre","Ingrese el nombre del plan"); ?>
										<?php echo textarea ("Descripcion","descripcion","descripcion","Ingrese la decripcion del plan"); ?>
