...
<head>
  ...
  <meta charset="utf-8">
  <title>Modulo <?php echo str_replace("_", " ", $titulo); ?> (Editar registro) - Adminsitrador</title>
              ...
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <?php echo textarea ("Descripcion","descripcion","descripcion","Ingrese la descripcion del plan",$detalle->descripcion,form_error('descripcion', '<div class="mensaje_error">', '</div>')); ?>
                    <?php 
