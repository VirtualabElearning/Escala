                        ...
                        <tbody>
                          ...
                          <?php foreach ($lista as $key => $value): ?>
                            ...
                            <tr id="<?php echo $value->id_contenidos; ?>">
                             ...
                             <td>  <a href="<?php echo $this->uri->segment(1); ?>/root/editar/<?php echo $value->id_contenidos; ?>" class="btn btn-info btn-xs"><i class="fa"></i> Editar</a> <a href="#" id="<?php echo $value->id_contenidos; ?>" class="btn btn-danger btn-xs lanzar_confirmacion"><i class="fa"></i> Borrar</a> </td>
                           </tr>
